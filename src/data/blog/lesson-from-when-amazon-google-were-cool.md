...
modDatetime:
title: Lessons from when Amazon and Google were cool
slug: lesson-from-when-amazon-google-were-cool
featured: false
draft: false
tags:
  - reflection
...
My good friends at the [Forbrukarrådet](http://localhost:4321/posts/lesson-from-when-amazon-google-were-cool) (the Norwegian Consumer Council) even turned the idea into an amazing video:
<iframe title="vimeo-player" src="https://player.vimeo.com/video/1168468796?h=ab28f6c45f" class="aspect-video embed-responsive embed-responsive-21by9 relative w-full mt-8" frameborder="0" referrerpolicy="strict-origin-when-cross-origin" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share"   allowfullscreen></iframe>

Amazon is a prime example of enshitifcation. It started as a good product, and a good idea. It made books available to people that couldn't previously access them. It provided a platform for merchants to sell their products without having to setup a website, payment system, delivery and so on. But over time it turned into an unavoidable giant that abuses its dominance for its own own profit. Refuse to be on Amazon and you might be invisible because people won't find your products. Accept to use it and you might see those very products [counterfeited by Amazon themselves](https://www.theverge.com/2021/3/3/22311574/peak-design-video-amazon-copy-everyday-sling-bag), despite being already paying whatever the company decides its fees are today. You might even be [forced to lower your prices](https://www.pymnts.com/amazon/2025/amazon-reportedly-pushing-suppliers-for-discounts-to-combat-tariffs/) so that the company can continue to offer the best possible deal. 
